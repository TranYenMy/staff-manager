...
@Component({
  selector: 'cons-detail-estimate-page',
  templateUrl: './detail-estimate-page.component.html',
  styleUrls: ['./detail-estimate-page.component.scss']
})
export class DetailEstimatePageComponent implements OnDestroy {
  ...
  private handleServiceAPI(payload: any): Observable<any> {
    if (this.currentTabIndex === 0) {
      ...
      console.log('importDetailEstimate');
      return this.balanceService.importDetailEstimate(payload);
    }
  ...
  onDownloadTemplate(): void {
    if (this.currentTabIndex === 0) {
      window.location.href = './assets/templates/DT_01.xlsx';
    } else if (this.currentTabIndex === 1) {
      window.location.href = './assets/templates/DT_CT.xlsx';
